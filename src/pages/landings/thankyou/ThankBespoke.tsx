  ...
  // const path = 'https://www.samsung.com.pe/premium-service';
    ...
    return (
        ...
        <Header/>
            ...
            {(isDesktop || isLaptop) && (
                <img className='imgBanner' src={`${path}/images/bespoke/main-banner-desktop.gif`} width="100%" alt='bespoke banner'/>
            )}
            {(isMobile || isTablet) && (
                <img className='imgBanner' src={`${path}/images/bespoke/main-banner-mobile.gif`} width="100%" alt='bespoke banner'/>
            )}
